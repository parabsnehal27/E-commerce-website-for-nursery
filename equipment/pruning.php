...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=77');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(PRUNING1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(PRUNING2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(PRUNING3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
