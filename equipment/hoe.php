...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=74');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(HOE.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(hoe1.webp);width: 30%;height: 350px;">
                </div>
