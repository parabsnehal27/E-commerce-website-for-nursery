...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=73');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(fork1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(fork2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(fork3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
