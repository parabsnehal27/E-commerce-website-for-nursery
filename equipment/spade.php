...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=80');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(spade1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(spade3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(spade2.webp);width: 30%;height: 350px;">
                </div>
                <div class="button">
