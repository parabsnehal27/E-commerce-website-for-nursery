...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=14');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(apple.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(apple1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of apple</b></h2> 
                    <div class="benefit-item">
                        <h5> May support weight loss</h5>
                        <h5>Could be good for your heart</h5> 
                   </div> 
                 </div>
               </div>
         </div>
