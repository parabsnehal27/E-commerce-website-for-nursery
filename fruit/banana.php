...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=15');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(banana plant.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(banana1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(banana2.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 250</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Banana</b></h2> 
                    <div class="benefit-item">
                        <h5> You can use stem fibres as natural craft materials. </h5>
                        <h5>Banana plant rhizomes are used for propagation.</h5> 
                   </div> 
                 </div>
               </div>
         </div>
