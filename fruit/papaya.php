...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=19');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(papaya.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(papaya1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Papaya</b></h2> 
                    <div class="benefit-item">
                        <h5>Treats dengue fever </h5>
                        <h5>Aids digestion </h5> 
                   </div> 
                 </div>
               </div>
         </div>
