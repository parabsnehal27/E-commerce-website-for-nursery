...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=16');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(guava.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(guava1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(guava2.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Guava</b></h2> 
                    <div class="benefit-item">
                        <h5>  May Help Lower Blood Sugar Levels</h5>
                        <h5>May Boost Heart Health</h5> 
                   </div> 
                 </div>
               </div>
         </div>
