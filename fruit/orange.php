...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=18');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(orange plant.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(orange1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(orange2.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Orange</b></h2> 
                    <div class="benefit-item">
                        <h5>  Protects your cells from damage </h5>
                        <h5>Makes it easier to absorb iron to fight anemia</h5> 
                   </div> 
                 </div>
               </div>
         </div>
