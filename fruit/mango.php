...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=17');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(mongo.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(mango1.jpg);width: 30%;height: 350px;">
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of mango</b></h2> 
                    <div class="benefit-item">
                        <h5> Excellent for hair problems</h5>
                        <h5>May treat stomach ulcers and hiccups  </h5> 
                   </div> 
                 </div>
               </div>
         </div>
