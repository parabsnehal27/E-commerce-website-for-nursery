...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=5');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(Basil.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(basil1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(basil2.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 150</h4></b><span>(3.0)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Basil</b></h2> 
                    <div class="benefit-item">
                        <h5>  Reduction of oxidative stress. </h5>
                        <h5>Reduced inflammation.</h5> 
                   </div> 
                 </div>
               </div>
         </div>
