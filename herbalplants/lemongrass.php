...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=8');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(Lemon Grass.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(lemongrass1.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(lemongrass3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 200</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Lemon Grass</b></h2> 
                    <div class="benefit-item">
                        <h5>  Boosting oral health </h5>
                        <h5>Boosting red blood cell levels</h5> 
                   </div> 
                 </div>
               </div>
         </div>
