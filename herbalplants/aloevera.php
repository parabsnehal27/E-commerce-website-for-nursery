      ...
      <?php
        ...
        ?>
         <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(aloevera1.avif); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(aloevera2.avif);width: 30%;height: 350px;">
                   
                </div>
                <div class="item" style="background-image: url(aloevera3.avif);width: 30%;height: 350px;">
                    
                </div>
                <div class="item" style="background-image: url(aloe\ vera.jpg);width: 30%;height: 350px;">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 300</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Aloe Vera</b></h2> 
                    <div class="benefit-item">
                        <h5> It has antioxidant and antibacterial properties</h5>
                        <h5> Boosts immunity</h5> 
                        <h5> Amazing for our Skin</h5> 
                   </div> 
                 </div>
               </div>
         </div>
