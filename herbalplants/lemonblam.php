...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=7');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(lemonbalm1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(lemonblam2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(lemonblam3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of LemonBlam</b></h2> 
                    <div class="benefit-item">
                        <h5> It may boost cognitive function</h5>
                        <h5>It may help treat cold sores</h5> 
                   </div> 
                 </div>
               </div>
         </div>
