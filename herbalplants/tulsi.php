...
<body>
   ...
   <main>
      <section>
         ...
         ?>
            <div class="slide">
                <div class="item" style="background-image: url(tulsi1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(tulsi2.avif);width: 30%;height: 350px;">
                   
                </div>
                <div class="item" style="background-image: url(tulsi3.jpg);width: 30%;height: 350px;">
                    
                </div>
                <div class="item" style="background-image: url(tulsi4.webp);width: 30%;height: 350px;">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 200</h4></b><span>(4.0)<i class="fa fa-star"></i></span>
                </div>
           </div>
            ...
            <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Tulsi</b></h2> 
                    <div class="benefit-item">
                        <h5> Natural Immunity Booster</h5>
                        <h5> Anti-cancer Properties</h5> 
                        <h5> Good for Heart Health</h5> 
                   </div> 
                 </div>
               </div>
         </div>
