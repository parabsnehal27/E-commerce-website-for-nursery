      ...
      <section>
        ...
        ?>
         <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(brahmi1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(Brahmi.jpg);width: 30%;height: 350px;">
            ...
            <form action="" class="form-submit">
               ...
               <h2><b>Benefits of Brahmi</b></h2> 
               <div class="benefit-item">
                  <h5> Contains powerful antioxidants</h5>
                  <h5> May boost brain function</h5> 
                  <h5> May prevent anxiety and stress</h5> 
               </div> 
            </div>
         </div>
         </div>
