...
<head>
   ...
   <title>BROKEN HEART PLANT</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=38');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(broken1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(broken3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(broken2.webp);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of BROKEN <br>HEART PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Low maintenance and beginner-friendly </h5>
                        <h5> Air purifying and easy to propagate,</h5> 
                   </div> 
                 </div>
               </div>
         </div>
