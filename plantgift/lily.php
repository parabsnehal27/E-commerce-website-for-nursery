...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=41');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(lily1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(lily2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(lily3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of LILY PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Adds aesthetics to indoors</h5>
                        <h5> Air purifying</h5> 
                   </div> 
                 </div>
               </div>
