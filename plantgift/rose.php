...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=42');
            $stmt->execute();
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of ROSE PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Treats skin inflammation or rashes</h5>
                        <h5>Reduces stress and treats insomnia</h5> 
                   </div> 
                 </div>
               </div>
         </div>
