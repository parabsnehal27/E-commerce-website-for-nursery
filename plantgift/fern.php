...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=39');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(fern1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(fern2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of FERN PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Ferns used for the blood </h5>
                        <h5> Ferns used for digestion</h5> 
                   </div> 
                 </div>
               </div>
         </div>
