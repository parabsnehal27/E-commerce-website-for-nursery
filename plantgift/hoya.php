...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=40');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(hoya1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(hoya2.jpg);width: 30%;height: 350px;">
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of HOYA PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Stress Relieving </h5>
