...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=24');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(money1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(money2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(money3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 500</h4></b><span>(3.0)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Money Plant</b></h2> 
                    <div class="benefit-item">
                        <h5>Provide positive a environment for better growth</h5>
                        <h5>Bring Good luck and Prosperity into your home</h5> 
                   </div> 
                 </div>
               </div>
         </div>
