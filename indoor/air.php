...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=21');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(air1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(air2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(air3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Air</b></h2> 
                    <div class="benefit-item">
                        <h5>Good for your Health</h5>
                        <h5>They are pet friendly</h5> 
                   </div> 
                 </div>
               </div>
         </div>
