...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=26');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(rubber1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(rubber2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(rubber3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Rubber</b></h2> 
                    <div class="benefit-item">
                        <h5>Rubber Plant Helps Purify Air</h5>
                        <h5>Rubber Plant Has Anti-Inflammatory Properties</h5> 
                   </div> 
                 </div>
               </div>
         </div>
