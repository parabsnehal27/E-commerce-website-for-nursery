...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=28');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(sweetheart1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(sweetheart2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(sweetheart plant.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               <h1>Sweetheart plant</h1>
               <div class="content-in">
                   <h4><b>₹ 550</h4></b><span>(4.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Sweetheart</b></h2> 
                    <div class="benefit-item">
                        <h5>Unique Heart-shaped Leaves and Aesthetic Appeal</h5>
                        <h5>Symbolism of Love and Friendship</h5> 
                   </div> 
                 </div>
               </div>
         </div>
