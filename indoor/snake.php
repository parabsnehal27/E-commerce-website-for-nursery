...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=29');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(snake1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(snake2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(snake3.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Snake</b></h2> 
                    <div class="benefit-item">
                        <h5>Filter indoor air, even at night</h5>
                        <h5>Remove toxic pollutants</h5> 
                   </div> 
                 </div>
               </div>
         </div>
