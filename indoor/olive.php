...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=25');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(olive1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(olive2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(olive tree.jpg);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="content">
               ...
               <div class="content-in">
                   <h4><b>₹ 450</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Olive</b></h2> 
                    <div class="benefit-item">
                        <h5>Bolsters Cardiovascular Health</h5>
                        <h5>Maintains Digestive Health</h5> 
                   </div> 
                 </div>
               </div>
         </div>
