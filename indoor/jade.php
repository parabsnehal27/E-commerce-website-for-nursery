...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=23');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(jade1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(jade2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(jade3.avif);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Jade</b></h2> 
                    <div class="benefit-item">
                        <h5>It Improves Indoor Air Quality</h5>
                        <h5> It Increases Humidity</h5> 
                   </div> 
                 </div>
               </div>
         </div>
