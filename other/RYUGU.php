...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=48');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(RYUGUPLANT1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(RYUGUPLANT2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
