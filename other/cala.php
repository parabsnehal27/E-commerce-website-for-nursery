...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=44');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(caladiums1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(caladiums2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(caladiums3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="content">
               <h4>CALADIUMS PLANT</h4>
               <div class="content-in">
                   <h4><b>₹ 150</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of CALADIUMS PLANT</b></h2> 
