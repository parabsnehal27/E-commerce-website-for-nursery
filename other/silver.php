...
<head>
   ...
   <title>ZEBRINA SILVER PLUS PLANT</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=49');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(silver1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(silver2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(silver3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="content">
               <h4>ZEBRINA SILVER PLUS PLANT</h4>
               <div class="content-in">
                   <h4><b>₹ 400</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of ZEBRINA SILVER <br>PLUS PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Natural air purifier:</h5>
                        <h5>Boosts mood and connects to nature</h5>
                   </div> 
                 </div>
               </div>
         </div>
