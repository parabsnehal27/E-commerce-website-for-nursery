...
<head>
   ...
   <title>BLACK LACE ELDER PLANT</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=43');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(ruku1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(black.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of BLACK LACE ELDER</b></h2> 
                    <div class="benefit-item">
                        <h5> Reducing Risk of Cancer</h5>
