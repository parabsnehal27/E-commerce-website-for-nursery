...
<head>
   ...
   <title>KURENAI JISHI PLANT</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=45');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(KURENAIJISHIPLANT1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(KURENAIJISHIPLANT2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of KURENAI<br> JISHI PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5> Spring Awakening</h5>
