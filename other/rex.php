...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=46');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(rex1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(rex2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(rex3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of REX BEGONIA PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Symbolizes love, friendship, and resilience</h5>
                        <h5>Purifies air</h5>
                   </div> 
                 </div>
               </div>
