...
<head>
   ...
   <title>POTASSIUM FERTILISERS</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=83');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(po2.jpg); width: 30%;height: 350px;">  
                </div>
