...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=32');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(hostas1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(hostas2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Hostas</b></h2> 
                    <div class="benefit-item">
                        <h5>LOW MAINTENANCE AND EASY TO GROW</h5>
                        <h5>PEST AND DISEASE RESISTANCE</h5> 
                   </div> 
                 </div>
               </div>
         </div>
