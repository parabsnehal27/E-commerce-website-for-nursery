...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=37');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(weigela1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(weigela2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Weigela</b></h2> 
                    <div class="benefit-item">
                        <h5>A Year-Round Spectacle</h5>
                        <h5>Drought Defender</h5> 
                   </div> 
                 </div>
               </div>
         </div>
