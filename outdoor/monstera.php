...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=33');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(monstera1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(monstera2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of MONSTERA PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Air Purifying Qualities</h5>
                        <h5>Increasing Humidity</h5> 
                   </div> 
                 </div>
               </div>
         </div>
