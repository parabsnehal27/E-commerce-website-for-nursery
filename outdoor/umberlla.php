...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=36');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(umberlla1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(umberlla2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(umberlla3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Umberlla</b></h2> 
                    <div class="benefit-item">
                        <h5>Pet-Friendly Nature</h5>
                        <h5>Decorative Value</h5> 
                   </div> 
                 </div>
               </div>
         </div>
