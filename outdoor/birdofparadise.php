...
<head>
   ...
   <title>BIRD OF PARADISE PLANT</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=30');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(BIRDOFPARADISE1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(BIRDOFPARADISE2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of BIRD OF<br> PARADISE PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Striking Appearance</h5>
                        <h5> Indoor and Outdoor Versatility</h5> 
                   </div> 
                 </div>
               </div>
         </div>
