...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=31');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(FERNSPLANT1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(FERNSPLANT2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of FERNS PLANT</b></h2> 
                    <div class="benefit-item">
                        <h5>Ferns as natural air purifiers in home</h5>
                   </div> 
                 </div>
               </div>
         </div>
