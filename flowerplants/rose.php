...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=9');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(rose1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(rose2.jpg);width: 30%;height: 350px;">
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Rose</b></h2> 
                    <div class="benefit-item">
                        <h5>  Rose gives you that goddess glow </h5>
                        <h5>Rose eases uncomfortable PMS symptoms</h5> 
                   </div> 
                 </div>
               </div>
         </div>
