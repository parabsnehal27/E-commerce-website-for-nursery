    ...
    <header>
      ...
      <?php
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(hibiscus.webp); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(hibiscus1.webp);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(hibiscusban.webp);width: 30%;height: 350px;">  
                </div>
                <div class="button">
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Hibiscus</b></h2> 
                    <div class="benefit-item">
                        <h5>  It may have antiseptic properties</h5>
                        <h5> Potential Uses of hibiscus for cancer</h5> 
                   </div> 
                 </div>
               </div>
         </div>
