...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=11');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(Frangipaniflower.webp); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(FRANGIPANI1.jpg);width: 30%;height: 350px;">
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of Frangipani</b></h2> 
                    <div class="benefit-item">
                        <h5>  The rich, strong, and exotic fragrance of frangipani<br> essential oil is used widely in perfumery</h5>
