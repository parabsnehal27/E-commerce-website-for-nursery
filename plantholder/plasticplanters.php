...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=54');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(plastic1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(plastic2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
            ...
            <div class="content">
               <h1>PLASTIC PLANTER</h1>
               <div class="content-in">
                   <h4><b>₹ 100</h4></b><span>(3.5)<i class="fa fa-star"></i></span>
                </div>
           </div>
