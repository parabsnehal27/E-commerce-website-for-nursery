    ...
    <header>
      ...
      <?php
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(wood1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(wood2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
