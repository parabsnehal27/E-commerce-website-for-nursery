...
<head>
   ...
   <title>SELF WATERING PLANTER</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=55');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(self1.jpg); width: 30%;height: 350px;">  
                </div>
                <div class="item" style="background-image: url(self2.jpg);width: 30%;height: 350px;">
                </div>
                <div class="item" style="background-image: url(self3.jpg);width: 30%;height: 350px;">
                </div>
                <div class="button">
