...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=61');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(pum1.jpg); width: 30%;height: 350px;">  
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of PUMPKIN SEEDS</b></h2> 
                    <div class="benefit-item">
                        <h5> Are Rich in Magnesium</h5>
                        <h5> Contain Healthy Fats and Fiber</h5> 
                   </div> 
                 </div>
               </div>
         </div>
