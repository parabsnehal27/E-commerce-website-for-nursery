...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=62');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(SUNFLOWER.jpg); width: 30%;height: 350px;">  
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of SUNFLOWER  SEEDS</b></h2> 
                    <div class="benefit-item">
                        <h5>Nutritional value of Sunflower Seeds</h5>
