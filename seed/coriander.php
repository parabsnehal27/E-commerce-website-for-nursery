...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=57');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(CORIANDER.jpg); width: 30%;height: 350px;">  
                </div>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of CORIANDER SEEDS</b></h2> 
                    <div class="benefit-item">
                        <h5>May help lower blood sugar </h5>
                        <h5>Rich in immune-boosting antioxidants</h5> 
                   </div> 
                 </div>
               </div>
         </div>
