...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=58');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(HIBISCUS.jpg); width: 30%;height: 350px;">  
                </div>
               
            </div>
            <div class="content">
               <h1>HIBISCUS SEEDS</h1>
            ...
            <div class="page-header">
              <form action="" class="form-submit">
                ...
                <div class="featured-content-list">
                    ...
                    <h2><b>Benefits of HIBISCUS SEEDS</b></h2> 
                    <div class="benefit-item">
                        <h5>It may have antiseptic properties</h5>
                        <h5>It may have blood sugar-lowering properties.</h5> 
                   </div> 
                 </div>
               </div>
         </div>
