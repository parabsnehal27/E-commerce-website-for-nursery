...
<head>
   ...
   <title>RED AND YELLOW SOIL</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=70');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(Red&YellowSoil.JPG); width: 30%;height: 350px;">  
                </div>
