...
<head>
   ...
   <title>PEATY AND MARSHY SOIL</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=68');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(PeatyandMarshySoil.JPG); width: 30%;height: 350px;">  
                </div>
               
            </div>
            <div class="content">
               <h3>PEATY AND MARSHY SOIL</h3>
