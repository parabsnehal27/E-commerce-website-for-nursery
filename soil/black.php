...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=65');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(BlackCottonSoil.JPG); width: 30%;height: 350px;">  
                </div>
               
            </div>
            <div class="content">
               <h3>BLACK COTTON SOIL</h3>
