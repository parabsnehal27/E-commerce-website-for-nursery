...
<head>
   ...
   <title>ARID AND DESERT SOIL</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=66');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(AridorDesertSoil.JPG); width: 30%;height: 350px;">  
                </div>
               
            </div>
            <div class="content">
               <h3>ARID AND DESERT SOIL</h3>
