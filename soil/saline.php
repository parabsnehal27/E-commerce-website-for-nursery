...
<head>
   ...
   <title>SALINE AND ALKALINE SOIL</title>
</head>
...
<body>
   <main>
    <header>
      ...
      <?php
            include '../config.php';
            $stmt = $conn->prepare('SELECT * FROM product where id=71');
            $stmt->execute();
        ...
        <div class="container">
            ...
            <div class="slide">
                <div class="item" style="background-image: url(salien.JPG); width: 30%;height: 350px;">  
                </div>
               
            </div>
            <div class="content">
               <h3>SALINE AND ALKALINE SOIL</h3>
